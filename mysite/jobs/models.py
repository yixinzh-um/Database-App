...
class Employer(models.Model) :
    ...
    headquarters = models.CharField(
            max_length=200,
            validators=[MinLengthValidator(2, "Employer must be greater than 2 characters")], null=True
    )
...
class Job(models.Model) :
    ...
    comments = models.ManyToManyField(settings.AUTH_USER_MODEL,
        through='Comment', related_name='Job_comments_owned')
...
class Comment(models.Model) :
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,null=True,related_name='job_comment_owner')
...
class Fav(models.Model) :
    job = models.ForeignKey(Job, on_delete=models.CASCADE,related_name='job_fav')
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,related_name='job_fav_user')
